...
export const withdrawalRequest = ({ amount, jwt }) => async dispatch => {
  ...
  try {
    ...
    const response = await api.post(`${baseUrl}/api/withdrawal/${amount}`, null, {
      headers: { Authorization: `Bearer ${jwt}` }  // headers bukan header
    });
...
export const proceedWithdrawal = ({ id, jwt, accept }) => async dispatch => {
  ...
  try {
    ...
    const response = await api.get(`${baseUrl}/api/admin/withdrawal/${id}/proceed/${accept}`, null, {
...
export const getWithdrawalHistory = jwt => async dispatch => {
  ...
  try {
    ...
    const response = await api.get(`${baseUrl}/api/withdrawal`, {
      headers: { Authorization: `Bearer ${jwt}` }
    });
...
export const getAllWithdrawalRequest = jwt => async dispatch => {
  ...
  try {
    ...
    const response = await api.get(`${baseUrl}/api/admin/withdrawal`, {
      headers: { Authorization: `Bearer ${jwt}` }
    });
...
export const addPaymentDetails = ({ paymentDetails, jwt }) => async dispatch => {
  ...
  try {
    ...
    const response = await api.post(`${baseUrl}/api/payment-details`, paymentDetails, {
      headers: { Authorization: `Bearer ${jwt}` }
    });
...
export const getPaymentDetails = ({ jwt }) => async dispatch => {
  ...
  try {
    ...
    const response = await api.get(`${baseUrl}/api/payment-details`, {
      headers: { Authorization: `Bearer ${jwt}` }
    });
