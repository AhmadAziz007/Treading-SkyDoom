...
export const getCoinList = (page) => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await api.get(`${baseUrl}/coins?page=${page}`);
...
export const fetchMarketChart = ({ coinId, days, jwt }) => async (dispatch) => {
  ...
  try {
    ...
    const response = await api.get(`${baseUrl}/coins/${coinId}/chart?days=${days}`, {
      headers: {
...
export const fetchCoinById = (coinId) => async (dispatch) => {
  ...
  try {
    ...
    const response = await api.get(`${baseUrl}/coins/${coinId}`);
...
export const searchCoin = (keyword) => async (dispatch) => {
  ...
  try {
    ...
    const response = await api.get(`${baseUrl}/coins/search?q=/${keyword}`);
